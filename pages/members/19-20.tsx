...
export const getStaticProps: GetStaticProps = async () => {
  let response = await fetch(
    "https://css-website.herokuapp.com/api/admin/members/19-20?year=2"
  );
  const Year2 = await response.json();

  response = await fetch(
    "https://css-website.herokuapp.com/api/admin/members/19-20?year=3"
  );
  const Year3 = await response.json();

  response = await fetch(
    "https://css-website.herokuapp.com/api/admin/members/19-20?year=4"
  );
